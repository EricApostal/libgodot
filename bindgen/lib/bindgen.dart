...
Future<void> generateGlobalConstants(
  ...
  for (Map<String, dynamic> constant in globalConstants.map(
  ...
  o.b('class GD {', () {
    ...
    for (final utilityFunction in apiInfo.api.utilityFunctions) {
      ...
      o.b('$methodSignature {', () {
        ...
        final returnInfo = ArgumentProxy.fromReturnType(
          utilityFunction.returnType,
        );
        ...
        o.b('${retString}using((arena) {', () {
          ...
          o.p(
            'void Function(GDExtensionTypePtr, Pointer<GDExtensionConstTypePtr>, int) m =',
          );
    ...
    o.b('static initBindings() {', () {
      ...
      for (final utilityFunction in apiInfo.api.utilityFunctions) {
        ...
        o.p(
          "_bindings.${name}Func = variantGetPtrUtilityFunction()(StringName.fromString('$name').nativePtr.cast(), ${utilityFunction.hash});",
        );
      }
    }, '}');
  }, '}');
