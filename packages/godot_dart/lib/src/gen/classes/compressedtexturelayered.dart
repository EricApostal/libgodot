...
class CompressedTextureLayered extends TextureLayered {
  CompressedTextureLayered(super.nativePtr);

  static final Pointer<Void> _mb_load =
      resolveMethodBind('CompressedTextureLayered', 'load', 166001499);
  ...
  static final Pointer<Void> _mb_get_load_path =
      resolveMethodBind('CompressedTextureLayered', 'get_load_path', 201670096);
