...
class NavigationPathQueryParameters3D extends RefCounted {
  ...
  static final Pointer<Void> _mb_get_pathfinding_algorithm =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_pathfinding_algorithm', 3398491350);
  ...
  static final Pointer<Void> _mb_set_path_postprocessing =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_path_postprocessing', 2267362344);
  ...
  static final Pointer<Void> _mb_get_path_postprocessing =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_path_postprocessing', 3883858360);
  ...
  static final Pointer<Void> _mb_set_start_position =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_start_position', 3460891852);
  ...
  static final Pointer<Void> _mb_get_start_position =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_start_position', 3360562783);
  ...
  static final Pointer<Void> _mb_set_target_position =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_target_position', 3460891852);
  ...
  static final Pointer<Void> _mb_get_target_position =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_target_position', 3360562783);
  ...
  static final Pointer<Void> _mb_set_navigation_layers =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_navigation_layers', 1286410249);
  ...
  static final Pointer<Void> _mb_get_navigation_layers =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_navigation_layers', 3905245786);
  ...
  static final Pointer<Void> _mb_set_metadata_flags =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_metadata_flags', 2713846708);
  ...
  static final Pointer<Void> _mb_get_metadata_flags =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_metadata_flags', 1582332802);
  ...
  static final Pointer<Void> _mb_set_simplify_path =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_simplify_path', 2586408642);
  ...
  static final Pointer<Void> _mb_get_simplify_path =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_simplify_path', 36873697);
  ...
  static final Pointer<Void> _mb_set_simplify_epsilon =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_simplify_epsilon', 373806689);
  ...
  static final Pointer<Void> _mb_get_simplify_epsilon =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_simplify_epsilon', 1740695150);
  ...
  static final Pointer<Void> _mb_set_path_return_max_length =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_path_return_max_length', 373806689);
  ...
  static final Pointer<Void> _mb_get_path_return_max_length =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_path_return_max_length', 1740695150);
  ...
  static final Pointer<Void> _mb_set_path_return_max_radius =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_path_return_max_radius', 373806689);
  ...
  static final Pointer<Void> _mb_get_path_return_max_radius =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_path_return_max_radius', 1740695150);
  ...
  static final Pointer<Void> _mb_set_path_search_max_polygons =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_path_search_max_polygons', 1286410249);
  ...
  static final Pointer<Void> _mb_get_path_search_max_polygons =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_path_search_max_polygons', 3905245786);
  ...
  static final Pointer<Void> _mb_set_path_search_max_distance =
      resolveMethodBind('NavigationPathQueryParameters3D', 'set_path_search_max_distance', 373806689);
  ...
  static final Pointer<Void> _mb_get_path_search_max_distance =
      resolveMethodBind('NavigationPathQueryParameters3D', 'get_path_search_max_distance', 1740695150);
