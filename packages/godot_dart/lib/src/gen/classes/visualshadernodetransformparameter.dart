...
class VisualShaderNodeTransformParameter extends VisualShaderNodeParameter {
  ...
  /// Constructs a brand-new engine-owned VisualShaderNodeTransformParameter instance
  /// (via classdb_construct_object3), not an existing one.
  factory VisualShaderNodeTransformParameter.create() {
    return VisualShaderNodeTransformParameter(resolveClassConstructor('VisualShaderNodeTransformParameter'));
  }
