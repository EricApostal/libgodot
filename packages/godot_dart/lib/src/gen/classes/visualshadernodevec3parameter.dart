...
class VisualShaderNodeVec3Parameter extends VisualShaderNodeParameter {
  ...
  /// Constructs a brand-new engine-owned VisualShaderNodeVec3Parameter instance
  /// (via classdb_construct_object3), not an existing one.
  factory VisualShaderNodeVec3Parameter.create() {
    return VisualShaderNodeVec3Parameter(resolveClassConstructor('VisualShaderNodeVec3Parameter'));
  }
