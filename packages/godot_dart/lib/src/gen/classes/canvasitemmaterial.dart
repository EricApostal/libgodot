...
class CanvasItemMaterial extends Material {
  ...
  /// Constructs a brand-new engine-owned CanvasItemMaterial instance
  /// (via classdb_construct_object3), not an existing one.
  factory CanvasItemMaterial.create() {
    return CanvasItemMaterial(resolveClassConstructor('CanvasItemMaterial'));
  }
