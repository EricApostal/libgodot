...
class PhysicsPointQueryParameters3D extends RefCounted {
  ...
  static final Pointer<Void> _mb_get_position =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'get_position', 3360562783);
  ...
  static final Pointer<Void> _mb_set_collision_mask =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'set_collision_mask', 1286410249);
  ...
  static final Pointer<Void> _mb_get_collision_mask =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'get_collision_mask', 3905245786);
  ...
  static final Pointer<Void> _mb_set_collide_with_bodies =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'set_collide_with_bodies', 2586408642);
  ...
  static final Pointer<Void> _mb_is_collide_with_bodies_enabled =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'is_collide_with_bodies_enabled', 36873697);
  ...
  static final Pointer<Void> _mb_set_collide_with_areas =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'set_collide_with_areas', 2586408642);
  ...
  static final Pointer<Void> _mb_is_collide_with_areas_enabled =
      resolveMethodBind('PhysicsPointQueryParameters3D', 'is_collide_with_areas_enabled', 36873697);
