...
class AudioStreamOggVorbis extends AudioStream {
  ...
  /// Constructs a brand-new engine-owned AudioStreamOggVorbis instance
  /// (via classdb_construct_object3), not an existing one.
  factory AudioStreamOggVorbis.create() {
    return AudioStreamOggVorbis(resolveClassConstructor('AudioStreamOggVorbis'));
  }
