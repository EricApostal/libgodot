...
class AudioStreamGenerator extends AudioStream {
  ...
  /// Constructs a brand-new engine-owned AudioStreamGenerator instance
  /// (via classdb_construct_object3), not an existing one.
  factory AudioStreamGenerator.create() {
    return AudioStreamGenerator(resolveClassConstructor('AudioStreamGenerator'));
  }
