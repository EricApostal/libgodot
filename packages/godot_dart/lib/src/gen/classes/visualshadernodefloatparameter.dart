...
class VisualShaderNodeFloatParameter extends VisualShaderNodeParameter {
  ...
  /// Constructs a brand-new engine-owned VisualShaderNodeFloatParameter instance
  /// (via classdb_construct_object3), not an existing one.
  factory VisualShaderNodeFloatParameter.create() {
    return VisualShaderNodeFloatParameter(resolveClassConstructor('VisualShaderNodeFloatParameter'));
  }
