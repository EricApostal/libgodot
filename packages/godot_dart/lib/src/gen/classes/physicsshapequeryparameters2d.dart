...
class PhysicsShapeQueryParameters2D extends RefCounted {
  PhysicsShapeQueryParameters2D(super.nativePtr);

  /// Constructs a brand-new engine-owned PhysicsShapeQueryParameters2D instance
  /// (via classdb_construct_object3), not an existing one.
  factory PhysicsShapeQueryParameters2D.create() {
    return PhysicsShapeQueryParameters2D(resolveClassConstructor('PhysicsShapeQueryParameters2D'));
  }

  static final Pointer<Void> _mb_set_shape =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_shape', 968641751);
  ...
  static final Pointer<Void> _mb_get_shape =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'get_shape', 121922552);
  ...
  static final Pointer<Void> _mb_set_transform =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_transform', 2761652528);
  ...
  static final Pointer<Void> _mb_get_transform =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'get_transform', 3814499831);
  ...
  static final Pointer<Void> _mb_set_motion =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_motion', 743155724);
  ...
  static final Pointer<Void> _mb_get_motion =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'get_motion', 3341600327);
  ...
  static final Pointer<Void> _mb_set_margin =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_margin', 373806689);
  ...
  static final Pointer<Void> _mb_get_margin =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'get_margin', 1740695150);
  ...
  static final Pointer<Void> _mb_set_collision_mask =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_collision_mask', 1286410249);
  ...
  static final Pointer<Void> _mb_get_collision_mask =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'get_collision_mask', 3905245786);
  ...
  static final Pointer<Void> _mb_set_collide_with_bodies =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_collide_with_bodies', 2586408642);
  ...
  static final Pointer<Void> _mb_is_collide_with_bodies_enabled =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'is_collide_with_bodies_enabled', 36873697);
  ...
  static final Pointer<Void> _mb_set_collide_with_areas =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'set_collide_with_areas', 2586408642);
  ...
  static final Pointer<Void> _mb_is_collide_with_areas_enabled =
      resolveMethodBind('PhysicsShapeQueryParameters2D', 'is_collide_with_areas_enabled', 36873697);
