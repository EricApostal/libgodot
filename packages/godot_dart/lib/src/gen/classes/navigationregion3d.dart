...
class NavigationRegion3D extends Node3D {
  ...
  void setNavigationMesh(NavigationMesh navigationMesh) {
    ...
    try {
      ptrcallVoid(_mb_set_navigation_mesh, nativePtr, [arg0.cast<Void>()]);
    } finally {
      malloc.free(arg0);
    }
  }
  ...
  static final Pointer<Void> _mb_get_navigation_mesh =
      resolveMethodBind('NavigationRegion3D', 'get_navigation_mesh', 1468720886);
  ...
  static final Pointer<Void> _mb_set_enabled =
      resolveMethodBind('NavigationRegion3D', 'set_enabled', 2586408642);
  ...
  static final Pointer<Void> _mb_is_enabled =
      resolveMethodBind('NavigationRegion3D', 'is_enabled', 36873697);
  ...
  static final Pointer<Void> _mb_set_use_edge_connections =
      resolveMethodBind('NavigationRegion3D', 'set_use_edge_connections', 2586408642);
  ...
  static final Pointer<Void> _mb_get_use_edge_connections =
      resolveMethodBind('NavigationRegion3D', 'get_use_edge_connections', 36873697);
  ...
  static final Pointer<Void> _mb_set_navigation_layers =
      resolveMethodBind('NavigationRegion3D', 'set_navigation_layers', 1286410249);
  ...
  static final Pointer<Void> _mb_get_navigation_layers =
      resolveMethodBind('NavigationRegion3D', 'get_navigation_layers', 3905245786);
  ...
  static final Pointer<Void> _mb_set_navigation_layer_value =
      resolveMethodBind('NavigationRegion3D', 'set_navigation_layer_value', 300928843);
  ...
  static final Pointer<Void> _mb_get_navigation_layer_value =
      resolveMethodBind('NavigationRegion3D', 'get_navigation_layer_value', 1116898809);
  ...
  static final Pointer<Void> _mb_set_enter_cost =
      resolveMethodBind('NavigationRegion3D', 'set_enter_cost', 373806689);
  ...
  static final Pointer<Void> _mb_get_enter_cost =
      resolveMethodBind('NavigationRegion3D', 'get_enter_cost', 1740695150);
  ...
  static final Pointer<Void> _mb_set_travel_cost =
      resolveMethodBind('NavigationRegion3D', 'set_travel_cost', 373806689);
  ...
  static final Pointer<Void> _mb_get_travel_cost =
      resolveMethodBind('NavigationRegion3D', 'get_travel_cost', 1740695150);
  ...
  static final Pointer<Void> _mb_bake_navigation_mesh =
      resolveMethodBind('NavigationRegion3D', 'bake_navigation_mesh', 3216645846);

  void bakeNavigationMesh(bool onThread) {
    final arg0 = malloc<Uint8>()..value = onThread ? 1 : 0;
    try {
      ptrcallVoid(_mb_bake_navigation_mesh, nativePtr, [arg0.cast<Void>()]);
    } finally {
      malloc.free(arg0);
    }
  }
  ...
  static final Pointer<Void> _mb_is_baking =
      resolveMethodBind('NavigationRegion3D', 'is_baking', 36873697);
  ...
  static final Pointer<Void> _mb_get_bounds =
      resolveMethodBind('NavigationRegion3D', 'get_bounds', 1068685055);
