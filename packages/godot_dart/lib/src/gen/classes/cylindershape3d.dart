...
class CylinderShape3D extends Shape3D {
  ...
  static final Pointer<Void> _mb_get_radius =
      resolveMethodBind('CylinderShape3D', 'get_radius', 1740695150);
  ...
  static final Pointer<Void> _mb_set_height =
      resolveMethodBind('CylinderShape3D', 'set_height', 373806689);
  ...
  static final Pointer<Void> _mb_get_height =
      resolveMethodBind('CylinderShape3D', 'get_height', 1740695150);
