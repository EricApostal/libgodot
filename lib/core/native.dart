...
class NativeBridge {
  ...
  static Future<GDExtensionFFI> loadLibGodot() async {
    final ByteData dylibData = await rootBundle.load('assets/libgodot.macos.template_debug.dev.arm64.dylib');
    final Uint8List dylibBytes = dylibData.buffer.asUint8List();

    final Directory tempDir = await getTemporaryDirectory();
    final String dylibPath = path.join(tempDir.path, 'libgodot.macos.template_debug.dev.arm64.dylib');
