...
class GodotDartNativeBindings {
  ...
  late final finalizeBuiltinObject = processLib
      .lookup<NativeFunction<Void Function(Pointer<Void>)>>(
        'finalize_builtin_object',
      );

  late final finalizeExtensionObject = processLib
      .lookup<NativeFunction<Void Function(Pointer<Void>)>>(
  ...
  late final tieDartToNative = processLib
      .lookup<
        NativeFunction<Void Function(Handle, GDExtensionObjectPtr, Bool, Bool)>
      >('tie_dart_to_native')
